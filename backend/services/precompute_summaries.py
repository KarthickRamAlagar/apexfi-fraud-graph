...
# DATASETS_METADATA = [
#     {"table": "ieee_cis_features", "name": "IEEE-CIS Transactions", "description": "Card transaction features — device, card, and behavioral signals.", "category": "Tabular", "source": "Kaggle (IEEE-CIS Fraud Detection)"},
#     {"table": "ieee_cis_transaction_edges", "name": "IEEE-CIS Transaction Graph", "description": "Derived edges: device_shared and card_shared, built from evidence (fraud lift).", "category": "Graph", "source": "Derived (device_shared, card_shared)"},
#     {"table": "dgraph_fin_nodes", "name": "DGraph-Fin Users", "description": "Finvolution user network nodes — 17 features, fraud/normal/background labels.", "category": "Graph", "source": "dgraph.xinye.com (Finvolution Group)"},
#     {"table": "dgraph_fin_edges", "name": "DGraph-Fin Connections", "description": "Emergency-contact relationships between users, with timestamps.", "category": "Graph", "source": "dgraph.xinye.com (Finvolution Group)"},
#     {"table": "rbi_money_rates", "name": "RBI Money Rates", "description": "Bank rate, SBI lending rate, call money rate — fiscal years 2000-01 to 2017-18.", "category": "Tabular", "source": "data.gov.in (RBI)"},
#     {"table": "npci_digital_payments_quarterly", "name": "NPCI Digital Payments (Quarterly)", "description": "Real digital-payment volume and value, 2022, by quarter.", "category": "Tabular", "source": "data.gov.in (NPCI)"},
#     {"table": "npci_digital_payments_monthly", "name": "NPCI Digital Payments (Monthly)", "description": "Real digital-payment volume and value, by month.", "category": "Tabular", "source": "data.gov.in (NPCI)"},
# ]
